...
import tk.munditv.chat.utils.VideoInfo;
import tk.munditv.chat.utils.YoutubeAdapter;
import tk.munditv.chat.utils.YoutubeConnector;

public class YTSearchActivity extends AppCompatActivity {
    ...
    private void searchOnYoutube(final String keywords){
        ...
        new Thread(){
            ...
            public void run(){
                ...
                YoutubeConnector yc = new YoutubeConnector(YTSearchActivity.this);
