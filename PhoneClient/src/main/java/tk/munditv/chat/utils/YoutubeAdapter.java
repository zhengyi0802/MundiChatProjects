...
import tk.munditv.chat.R;
import tk.munditv.chat.ytplayer.PlayerActivity;
...
public class YoutubeAdapter extends RecyclerView.Adapter<YoutubeAdapter.MyViewHolder> {
    ...
    public YoutubeAdapter(Context mContext, List<VideoInfo> mVideoList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        final VideoInfo singleVideo = mVideoList.get(position);
        ...
        holder.video_title.setText(singleVideo.getVideoTitle());
